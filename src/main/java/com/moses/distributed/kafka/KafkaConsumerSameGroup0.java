...
// kafka-topics.sh --create --zookeeper localhost:2181 --replication-factor 1 --partitions 10 --topic replica-topic
public class KafkaConsumerSameGroup0 extends ShutdownableThread{
	//High level consumer
	//Low level consumer
	
	private final KafkaConsumer<Integer, String> consumer;
	
	public KafkaConsumerSameGroup0() {
	...
	public static void main(String[] args) {
		KafkaConsumerSameGroup0 consumer = new KafkaConsumerSameGroup0();
		consumer.start();
	}
}
