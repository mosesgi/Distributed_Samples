...
public class KafkaConsumerSameGroup1 extends ShutdownableThread{
	//High level consumer
	//Low level consumer
	
	private final KafkaConsumer<Integer, String> consumer;
	
	public KafkaConsumerSameGroup1() {
	...
	public static void main(String[] args) {
		KafkaConsumerSameGroup1 consumer = new KafkaConsumerSameGroup1();
		consumer.start();
	}
}
